                                                ...
                                                <form onSubmit={handleFormSubmit(product)}>
                                                    <div className="card product-item border-0 mb-4">
                                                        <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                                            <img className="img-fluid w-100" src={product.pictures} alt="" />
                                                        </div>
                                                        <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                                            <h6 className="text-truncate mb-3">{product.id}</h6>
                                                            <h6 className="text-truncate mb-3">{product.name}</h6>
                                                            <div className="col-sm-3 ">
                                                                <input type="number" name="quantite" className="form-control d-flex justify-content-center" defaultValue={localStorage.getItem(`card-${product.id}-quantity`) || "Quantité"} id="inlineFormInputName" min="0" placeholder="Quantité" onChange={(e) => {
